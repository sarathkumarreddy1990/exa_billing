...
const api = {
    ...
    getWLQueryColumns: function (args) {
        ...
        let stdcolumns = [
            ...
            `AGE('${moment().format('YYYY-MM-DD')}', submitted_dt) >= '3 days'::INTERVAL AND claim_status.code = 'PA' AS claim_resubmission_flag`
        ];
...

            {
                ...
                if (args.customArgs.filter_id === 'resubmission_claims') {
                    ...
                    whereClause.permission_filter = AND( whereClause.permission_filter, ` claims.billing_method = 'electronic_billing'
                                         AND AGE('${current_date}'::DATE, submitted_dt) >= '3 days'::INTERVAL
