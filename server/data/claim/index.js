    ...
    getClaimData: async (params) => {
        ...
        const get_claim_sql = SQL`
                SELECT
                    ...
                    , COALESCE(ipp.inactivated_dt, cpi.valid_to_date) AS p_valid_to_date
                    ...
                    , COALESCE(ips.inactivated_dt, csi.valid_to_date) AS s_valid_to_date
                    ...
                    , COALESCE(ipt.inactivated_dt, cti.valid_to_date) AS t_valid_to_date
