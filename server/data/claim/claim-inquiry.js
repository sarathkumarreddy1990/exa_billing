    ...
    getData: async (params) => {
        ...
        FROM (
            SELECT
                ...
                , orders.order_no
                , public.get_payer_name(bc.id, bc.pos_map_id) AS service_location
        ...
        let sql = SQL`
                    SELECT
                        ...
                        ,(CASE
                            ...
                            WHEN payer_type = 'service_facility_location' THEN public.get_payer_name(claims.id, claims.pos_map_id)
                          END) AS payer_name
                        , claim_dt
                        , claims.facility_id
                        , claims.created_dt
