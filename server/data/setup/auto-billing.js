...
const getSaveClaimParams = async (params) => {
    ...
    const saveClaimParams = {
        ...
        claims: {
            ...
            ...claim_details,
            facility_rendering_provider_contact_id: claim_details.fac_rendering_provider_contact_id,
            rendering_provider_contact_id: claim_details.fac_rendering_provider_contact_id || claim_details.rendering_provider_contact_id,
            study_rendering_provider_contact_id: claim_details.rendering_provider_contact_id || null,
