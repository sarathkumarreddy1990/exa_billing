                ...
                if (!this.gridLoaded) {
                    ...
                    this.paymentTable.render({
                        ...
                        colModel: [
                            ...
                            { name: 'amount', width: 215, moneyValidator : true },
                            { name: 'applied', width: 215, hidden: showGridColumn, moneyValidator : true },
                            { name: 'available_balance', width: 215, moneyValidator : true },
                            { name: 'adjustment_amount', width: 215, hidden: showGridColumn, moneyValidator : true },
