define([
    ...
    , 'backbone'
    , 'shared/report-utils'
    , 'text!templates/reports/monthly-recap.html'
],
    ...
    function ($, _, Backbone, UI, monthlyRecapTemplate) {
        ...
        var MonthlyRecapView = Backbone.View.extend({
            ...
            events: {
                ...
                'click #btnViewReportNewTabMonthlyRecap': 'onReportViewClick',
            ...
            onReportViewClick: function (e) {
                ...
                var openInNewTab = btnClicked ? btnClicked.attr('id') === 'btnViewReportNewTabMonthlyRecap' : false;
