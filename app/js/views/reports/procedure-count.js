define([
    ...
    , 'backbone'
    , 'shared/report-utils'
    , 'text!templates/reports/procedure-count.html'
],
    function ($, _, Backbone, UI, ProcedureCountTemplate) {
        ...
        var ProcedureCountView = Backbone.View.extend({
            ...
            events: {
                ...
                'click #btnViewReportNewTabProCount': 'onReportViewClick',
            ...
            onReportViewClick: function (e) {
                ...
                var openInNewTab = btnClicked ? btnClicked.attr('id') === 'btnViewReportNewTabProCount' : false;
