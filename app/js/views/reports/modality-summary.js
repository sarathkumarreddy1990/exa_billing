define([
    ...
    , 'backbone'
    , 'shared/report-utils'
    , 'text!templates/reports/modality-summary.html'
],
    function ($, _, Backbone, UI, ModalitySummaryTemplate) {
        ...
        var ModalitySummaryView = Backbone.View.extend({
            ...
            drpStudyDt: null,
            expanded: false,
            mainTemplate: _.template(ModalitySummaryTemplate),
            viewModel: {
                facilities: null,
                dateFrom: null,
                dateTo: null,
            ...
            events: {
                ...
                'click #btnViewReportNewTabModalitySummary': 'onReportViewClick',
            ...
            onReportViewClick: function (e) {
                ...
                var openInNewTab = btnClicked ? btnClicked.attr('id') === 'btnViewReportNewTabModalitySummary' : false;
