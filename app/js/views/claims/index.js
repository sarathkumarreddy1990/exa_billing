            ...
            getBillFee: function () {
                ...
                $('#tBodyCharge').find('tr').each(function (index) {
                    ...
                    arrBillFee.push({
                        ...
                        modifier1_id: $('#txtModifier1_' + dataRowId).attr('data-id') ? parseInt($('#txtModifier1_' + dataRowId).attr('data-id')) : null,
                        modifier2_id: $('#txtModifier2_' + dataRowId).attr('data-id') ? parseInt($('#txtModifier2_' + dataRowId).attr('data-id')) : null,
                        modifier3_id: $('#txtModifier3_' + dataRowId).attr('data-id') ? parseInt($('#txtModifier3_' + dataRowId).attr('data-id')) : null,
                        modifier4_id: $('#txtModifier4_' + dataRowId).attr('data-id') ? parseInt($('#txtModifier4_' + dataRowId).attr('data-id')) : null,
