    ...
    function ($, 
        ...
        var claimView = Backbone.View.extend({
            ...
            checkInsuranceEligibility: function (e) {
                ...
                $.ajax({
                    url: '/exa_modules/billing/claims/create_claim/eligibility',
                    type: "POST",
                    dataType: "json",
            ...
            showEditClaimForm: function (claim_Id, isFrom, options) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/exa_modules/billing/claims/create_claim',
                    data: {
                        id: claim_Id
                    },
            ...
            getLineItemsAndBind: function (selectedStudyIds) {
                ...
                if (selectedStudyIds) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/exa_modules/billing/claims/create_claim/get_line_items',
                        data: {
                            from: 'claimCreation',
            ...
            bindCPTUpdateEvents: function (el) {
                $(el).click(function (e) {
                    ...
                    if (type == 'cptCheck' || type == 'cptDescCheck') {
                        ...
                        var selCPTElement = $('#select2-' + txtElement + id + '-container');
                        ...
                        $(lblCptCodeElement)
                            ...
                            .attr({
                                'data_id': cpt_id,
                                'data_description': cpt_description,
                                'data_code': cpt_code
                            });
                        $(lblCptDescElement)
                            .html(cpt_description)
                            .attr({
                                'data_id': cpt_id,
                                'data_description': cpt_description,
                                'data_code': cpt_code
            ...
            setCptValues: function (rowIndex, res, duration, units, fee, type) {
                var txtCptEl = type == 'code' ?  'txtCptCode_' + rowIndex : 'txtCptDescription_' + rowIndex;
                $('#select2-' + txtCptEl + '-container').html(res.display_code).attr('title', res.display_code);
                $('#select2-' + txtCptEl + '-container').attr('data_code', res.display_code);
                $('#select2-' + txtCptEl + '-container').attr('data_description', res.display_description);
                $('#select2-' + txtCptEl + '-container').attr('data_id', res.id);
            ...
            bindServiceType: function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/exa_modules/billing/claims/create_claim/service_facilities',
                    data: {
                    },
                    success: function (model, response) {
           ...
           assignExistInsurance: function (e) {
            ...
            selectPatient: function (e) {
                ...
                if (!$studyDetails.is(':visible')) {
                    ...
                    jQuery.ajax({
                        url: "/exa_modules/billing/claims/create_claim/studiesby_patient_id",
                        type: "GET",
                        data: {
                            id: patientId,
                            company_id: app.companyID
