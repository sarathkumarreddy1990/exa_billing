    ...
    function ($,
        ...
        var claimView = Backbone.View.extend({
            ...
            bindDefaultClaimDetails: function (claim_data) {
                ...
                var orderingFacility = claim_data.pos == "OFP" ? claim_data.ptn_ordering_facility_name : claim_data.ordering_facility_name || claim_data.service_facility_name || self.usermessage.selectOrdFacility;
                ...
                self.ordering_facility_id = claim_data.pos == "OFP" ? claim_data.ptn_ordering_facility_id : claim_data.ordering_facility_id || claim_data.service_facility_id || null;
                self.ordering_facility_name = orderingFacility;
                self.ordering_facility_contact_id = claim_data.pos == "OFP" ? claim_data.ptn_ordering_facility_contact_id :claim_data.ordering_facility_contact_id || claim_data.service_facility_contact_id || null;
