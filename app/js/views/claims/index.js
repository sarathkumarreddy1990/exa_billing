        ...
        var claimView = Backbone.View.extend({
            ...
            updateResponsibleList: function (payer_details, paymentDetails) {
                ...
                if (!paymentDetails) {
                    ...
                    responsibleEle = $('#ddlPayerName_' + paymentDetails.id);
           ...
           assignExistInsurance: function (e) {
            ...
            setClaimDetails: function () {
                ...
                var primary_insurance_details = {
                    ...
                    subscriber_dob: $('#txtPriDOB').val() != '' ? moment($('#txtPriDOB').val()).format('YYYY-MM-DD') : null,
                ...
                secondary_insurance_details = {
                    ...
                    subscriber_dob: $('#txtSecDOB').val() != '' ? moment($('#txtSecDOB').val()).format('YYYY-MM-DD') : null,
                ...
                teritiary_insurance_details = {
                    ...
                    subscriber_dob: $('#txtTerDOB').val() != '' ? moment($('#txtTerDOB').val()).format('YYYY-MM-DD') : null,
                    medicare_insurance_type_code: null,
            ...
            bindPaymentEvent: function () {
                ...
                $('.paymentApply').off().click(_.debounce(function (e) {
                    ...
                    var rowID = $($tr).attr('data_row_id');
                    var paymentID = $($tr).attr('data_payment_id') || 0;
                    ...
                    self.pendingPayments.fetch({
                        ...
                        success: function (model, result) {
                            if (result && result.length) {
                                var gridData = _.filter(result, { 'payment_application_id': paymentApplicationID });
