...
module.exports = {
     ...
     *
     * @param  {object} recordDescriptor    Object with instructions on how to format the output
     * @param  {object} defaults
     * @return {object}                  description
     */
    hydrateRecordDescriptor: (recordDescriptor, makeDefaults = () => ({})) => {
        Object.keys(recordDescriptor).forEach((fieldName) => {

            const fieldDescriptor = recordDescriptor[fieldName];
            const defaults = makeDefaults(fieldDescriptor);
            ...
            if ( typeof fieldDescriptor.isLeftJustified === `undefined` ) {
                fieldDescriptor.isLeftJustified = !!defaults.isLeftJustified;
            }
            ...
            // NOTE do this *after* setting paddingChar (or other string manip things - isLeftJustified, etc
