...
SELECT l_company_id
      ...
      ,'recoupment_debit'
 WHERE
 NOt EXISTS ( SELECT 1 FROM  billing.adjustment_codes WHERE company_id = 1 and code = 'ERAREC');
...
SELECT l_company_id
      ...
      ,'credit'
 WHERE
 NOT EXISTS ( SELECT 1 FROM  billing.adjustment_codes WHERE company_id = 1 and code = 'ERA');
-- --------------------------------------------------------------------------------------------------------------------
