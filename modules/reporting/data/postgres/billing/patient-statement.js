...
const api = {
    ...
    getpatientStatementDataSetQueryContext: (reportParams) => {
        ...
        //filters.whereDate = queryBuilder.whereDateInTz(`CASE  WHEN type = 'charge'THEN  bc.claim_dt WHEN  type = 'payment' THEN bp.accounting_dt ELSE py.accounting_date END`, `<=`, [params.length], `f.time_zone`);
